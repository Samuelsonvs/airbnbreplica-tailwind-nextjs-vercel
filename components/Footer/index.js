    ...
    return (
        <div className="mt-10 px-10">
            <ul className="flex flex-col md:flex-row md:justify-between">
                {footerData.map((state) => {
                    return (
                        <li
                            key={state._id}
                            className="border-b md:border-none pb-5 md:pb-0"
                        >
                            <h4 className="py-5 text-sm font-semibold">
                                {state.head}
                            </h4>
                            <ul className="sm:flex sm:flex-wrap md:flex-none">
                                {state.data.map((data, index) => {
                                    return (
                                        <li
                                            key={index}
                                            className="py-2 text-sm sm:w-1/3 md:w-full"
                                        >
                                            <Link href="#">
            ...
            <div className="md:mt-10 md:border-t text-sm">
                <div className="py-5 flex flex-col-reverse sm:items-center md:flex-row md:justify-between">
                    <div className="flex">
                        <div>© 2021 Airbnb, Inc.</div>
                        <Link href="#">
                            <a className="hover:underline">
                                <div
                                    className={`${styles.before} relative pl-4`}
                                >
                                    Privacy
                                </div>
                            </a>
                    ...
                    <div className="flex">
                        <div>
                            <span>
                                <svg
                                    className="inline -mt-1 h-4 fill-current"
                                    viewBox="0 0 16 16"
                            ...
                            <span className="ml-1 underline">English (US)</span>
                            <span className="ml-5">
                                <Link href="#">
